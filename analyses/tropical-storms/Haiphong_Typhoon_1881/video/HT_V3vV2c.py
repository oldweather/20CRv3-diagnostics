...
parser.add_argument("--opdir", help="Directory for output files",
                    default="%s/images/Haiphong_Typhoon" % \
                                           os.getenv('SCRATCH'),
...
projection=ccrs.RotatedPole(pole_longitude=300, pole_latitude=56)
scale=30
...
# Output as png
fig.savefig('%s/V3vV2c_Haiphong_%04d%02d%02d%02d%02d.png' % 
