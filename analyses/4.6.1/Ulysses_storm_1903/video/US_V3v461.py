...
parser.add_argument("--opdir", help="Directory for output files",
                    default="%s/images/Ulysses_storm" % \
                                           os.getenv('SCRATCH'),
...
# Contour spread plot of ensemble members
mg.pressure.plot(ax_2c,prmsl,scale=0.01,type='spread',
                   resolution=0.05,
                   levels=numpy.arange(870,1050,10))

# 20CRv3 label
mg.utils.plot_label(ax_2c,'20CR v3',
...
# Contour spread plot of ensemble members
mg.pressure.plot(ax_3,prmsl,scale=0.01,type='spread',
                   resolution=0.05,
                   levels=numpy.arange(870,1050,10))

mg.utils.plot_label(ax_3,'20CR 4.6.1',
                     facecolor=fig.get_facecolor(),
                     x_fraction=0.02,
                     horizontalalignment='left')
...
# Output as png
fig.savefig('%s/V3vV461_Ulysses_storm_%04d%02d%02d%02d%02d.png' % 
