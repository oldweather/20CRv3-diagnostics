...
def get_sample_cube(start=datetime.datetime(1851,1,1,0,0),
    ...
    c=iris.load_cube('%s/20CR/version_3/monthly_means/%04d/PRATE.%04d.mnmean_mem039.nc' % 
    ...
    if climatology is None:
        ...
        for year in range(1961,1991):
             ...
             for member in range(1,81):
                 f=iris.load_cube('%s/20CR/version_3/monthly_means/%04d/PRATE.%04d.mnmean_mem%03d.nc' % 
    ...
    for member in range(1,81):
        ...
        for year in range(start.year,end.year+1):
            ...
            h=iris.load_cube('%s/20CR/version_3/monthly_means/%04d/PRATE.%04d.mnmean_mem%03d.nc' % 
                                                               (os.getenv('SCRATCH'),year,year,member),
                             iris.Constraint(name='Precipitation rate') &
