...
tfile.write(
    "mkdir -p %s/20CRv3.final/version_%d.%d.%d/%02d/%02d\n"
    % (
        os.getenv("SCRATCH"),
...
tfile.write(
    "%s/extract_anl_var.py --startyear=%d --year=%d --month=%d --version=%d --var=prmsl &\n"
    % (ldir, args.startyear, args.year, args.month, args.version)
)
tfile.write(
    "%s/extract_anl_var.py --startyear=%d --year=%d --month=%d --version=%d --var=air.2m &\n"
    % (ldir, args.startyear, args.year, args.month, args.version)
)
tfile.write(
    "%s/extract_anl_var.py --startyear=%d --year=%d --month=%d --version=%d --var=uwnd.10m &\n"
    % (ldir, args.startyear, args.year, args.month, args.version)
)
tfile.write(
    "%s/extract_anl_var.py --startyear=%d --year=%d --month=%d --version=%d --var=vwnd.10m &\n"
    % (ldir, args.startyear, args.year, args.month, args.version)
)
tfile.write(
    "%s/extract_anl_var.py --startyear=%d --year=%d --month=%d --version=%d --var=air.sfc &\n"
    % (ldir, args.startyear, args.year, args.month, args.version)
)
tfile.write(
    "%s/extract_anl_var.py --startyear=%d --year=%d --month=%d --version=%d --var=icec &\n"
    % (ldir, args.startyear, args.year, args.month, args.version)
)
...
#                                                         (ldir,args.startyear,args.year,args.month,args.version))
tfile.write(
    "%s/extract_fg_var.py --startyear=%d --year=%d --month=%d --version=%d --var=prate &\n"
    % (ldir, args.startyear, args.year, args.month, args.version)
)
tfile.write(
    "%s/extract_obs.py --startyear=%d --year=%d --month=%d --version=%d &\n"
    % (ldir, args.startyear, args.year, args.month, args.version)
)
tfile.write("wait\n")
