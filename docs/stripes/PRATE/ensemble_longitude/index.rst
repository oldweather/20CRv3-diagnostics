...
PRATE ensemble stripes by longitude
===================================
...
.. figure:: ../../../../analyses/stripes/PRATE/ensemble_longitude/PRATE.png
   ...
   Monthly mean precipiation rate anomalies (w.r.t. 1961-90) from the 20CRv3 ensemble. The vertical axis is longitude, and each pixel is an area-weighted latitudinal mean from a randomly selected ensemble member.
