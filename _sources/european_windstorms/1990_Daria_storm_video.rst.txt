...
.. raw:: html
    ...
    <center>
    <table><tr><td><center>
    <iframe src="https://player.vimeo.com/video/267410944?title=0&byline=0&portrait=0" width="795" height="448" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center></td></tr>
...
`The Burn's Day Storm, also called Cyclone Daria,  <https://en.wikipedia.org/wiki/Burns%27_Day_Storm>`_ was one of the most damaging European windstorms on record.
...
.. literalinclude:: ../../analyses/european_windstorms/Daria_1990/video/Daria_V3vV2c.py
...
.. literalinclude:: ../../analyses/european_windstorms/Daria_1990/video/make_frames.py

To turn the thousands of images into a movie, use `ffmpeg <http://www.ffmpeg.org>`_

.. code-block:: shell

    ffmpeg -r 24 -pattern_type glob -i Daria/\*.png \
