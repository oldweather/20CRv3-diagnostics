...
.. raw:: html
    ...
    <center>
    <table><tr><td><center>
    <iframe src="https://player.vimeo.com/video/268017506?title=0&byline=0&portrait=0" width="795" height="448" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></center></td></tr>
...
.. literalinclude:: ../../analyses/european_windstorms/North_German_Express_1894/video/NGE_V3vV2c.py
...
.. literalinclude:: ../../analyses/european_windstorms/North_German_Express_1894/video/make_frames.py

To turn the thousands of images into a movie, use `ffmpeg <http://www.ffmpeg.org>`_

.. code-block:: shell

    ffmpeg -r 24 -pattern_type glob -i North_German_Express/\*.png \
           -c:v libx264 -threads 16 -preset slow -tune animation \
           -profile:v high -level 4.2 -pix_fmt yuv420p -crf 25 \
           -c:a copy North_German_Express.mp4
