...
.. literalinclude:: ../../../analyses/stripes/PRATE/ensemble/get_slice.py

And then running that script for each year as a separate task:

.. literalinclude:: ../../../analyses/stripes/PRATE/ensemble/make_all_slices.py

Then assemble the slices to make the figure:

.. literalinclude:: ../../../analyses/stripes/PRATE/ensemble/stripes.py
